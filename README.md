...
The control panel of our high-level puzzle generator. There are 6 components in the control panel: **Parameter Control**, **Status Bar**, **High Level Puzzle Creator**, **Assembly State Viewer** and **Render Control**.
<p align="center">
  <a href="" rel="noopener">
...
- ### Parameter Control
  ...
  `Target Level (construction)` Determine the level of difficulty *L*. The program will keep running until constructing a puzzle with level of difficulty equal or higher than *L*.
  
  `Target Level (modifying)` The target level after modifying current puzzle.
